...
def showCal() :
	...
	new_gui.title("SOPHY CALENDAR")
 

	# Set the configuration of GUI window
	new_gui.geometry("700x600")
...
if __name__ == "__main__" :
	...
	# set the name of tkinter GUI window
	gui.title("SOPHY CALENDER")

	# Set the configuration of GUI window
	gui.geometry("250x180")

	# Create a CALENDAR : label with specified font and size
	cal = Label(gui, text = "SOPHY CALENDAR", bg = "white",
							font = ("times", 28, 'bold'))

	# Create a Enter Year : label
	year = Label(gui, text = "Enter Year", bg = "yellow")
